...
export type LedgerCollection = "accounts" | "categories" | "expenses" | "plans" | "tripPlans" | "loans" | "recurringIncomeSources" | "notifications" | "reminderSettings" | "deviceTokens" | "routines" | "routineAttendance";
